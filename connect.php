...
$response = $lsJSONRPCClient->export_responses($sessionKey,$survey_id,'json',null,'all', null, 'short');

$response = json_decode(base64_decode($lsJSONRPCClient->export_responses($sessionKey,$survey_id,'json')),true);

$nilai = $response['responses'];
