        ...
        <div class="row" id="kinerja">
            <div class="col-md-12 articles" id="site-content">
                ...
                <article class="posts">
                    ...
                    $cek_kinerja = mysqli_query($link, "SELECT * FROM `nilai_kepuasan`");
        ...
        <div class="row" id="kompetensi">
            <div class="col-md-12 articles" id="site-content">
                ...
                <article class="posts">
                    ...
                    $cek_kompetensi = mysqli_query($link, "SELECT * FROM `nilai_kepuasan`");
                    ...
                    if ($arrKompetensi['id'] != $id_kompetensi) {
                        ...
                        mysqli_query($link, "UPDATE `nilai_kepuasan` SET `id`=001,`a1`=$kompetensi_1,`a2`=$kompetensi_2,`a3`=$kompetensi_3,`a4`=$kompetensi_4,`a5`=$kompetensi_5 WHERE `id`=001");
                        // echo "Data Update";
                    }
        ...
        <div class="row" id="attitude">
            <div class="col-md-12 articles" id="site-content">
                ...
                <article class="posts">
                    ...
                    $cek_attitude = mysqli_query($link, "SELECT * FROM `nilai_kepuasan`");
